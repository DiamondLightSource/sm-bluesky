...
from sm_bluesky.beamlines.p99.plans.sample_stage_scanning import (
    trajectory_fly_scan
)
...
RE(
    trajectory_fly_scan(
        slow_start=1, slow_stop=2, slow_num=10, fast_start=0, fast_stop=1, fast_num=10, duration=1, panda=p
    )
)
